...
Generate a city, look up its time, report it. The ADK graphs 'Get started' example expressed as IR.
...
folder: `adk run city_time_workflow "your input"` (one-shot) or `adk web .` (browser UI).
