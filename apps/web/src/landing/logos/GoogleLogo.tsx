/**
 * Google (Vertex AI) mark, inlined from lobe-icons:
 * https://raw.githubusercontent.com/lobehub/lobe-icons/refs/heads/master/packages/static-svg/icons/vertexai.svg
 *
 * Inline JSX (not an .svg import) so `fill="currentColor"` inherits the
 * landing half's CSS `color` — the hover recolor — and the
 * vite-plugin-singlefile build needs no asset handling. Sizing comes from
 * the caller's className; the half carries the visible text label, so the
